...
weather_station_list = [("Abha", 18.0),
                                                                        ("Abidjan", 26.0),
                                                                        ("Abéché", 29.4),
                                                                        ("Accra", 26.4),
                                                                        ("Addis Ababa", 16.0),
...
if __name__ == "__main__":
    ...
    parser.add_argument('-r', '--rows', action='store', type=int, default=100, help="row count")

    args = parser.parse_args()

    if not args.rows:
        print("Error: Missing Row count argument")
        parser.print_help()
        sys.ex(1)

    fill_rows(count=args.rows)